...
SECRET_KEY = os.environ.get('JWT_SECRET', 'django-insecure-payment-service-key')
DEBUG = os.environ.get('DEBUG', 'True') == 'True'
ALLOWED_HOSTS = ['*', 'localhost', 'payment_service', '127.0.0.1']
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'payments_db'),
